			...
			<ul class="nav navbar-nav side-nav">
				...
				<li><a href="javascript:;" data-toggle="collapse"
					...
					<ul id="demo" class="collapse">
						...
						<li class="active"><a href="${contextPath}/addmenu">Create
								Menu</a></li>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-edit"></i> Add Menu</li>
						</ol>
					</div>
				</div>
				<!-- /.row -->
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<form role="form" action="${contextPath}/addmenu.htm"
							method="post">
							...
							<div class="form-group">
								<label>Select Multiple Menu Items</label> <select multiple
									class="form-control" name="itemList">

									<c:forEach items="${requestScope.menuitems}" var="menuitem">

										<option value="${menuitem.itemName}">${menuitem.itemName}</option>
							...
							<div class="form-group">
								<c:forEach items="${requestScope.menuitems}" var="menuitem">
									...
									<img height="150" width="150" src="${menuitem.filename}" />
							...
							<input type="submit" class="btn btn-default" value="Add Menu">
							<div class="form-group">
								<c:if test="${ not empty requestScope.addStatus}">

									<c:choose>
										<c:when test="${requestScope.addStatus.equals('Menu Added Successfully!')}">
        								<label id="status" class="alert alert-success"> <c:out
											value="${requestScope.addStatus}" />
									</label>
        								
    									</c:when>
										<c:when test="${requestScope.addStatus.equals('Failed to add menu, Please try again!')}">
