			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<form role="form" action="${contextPath}/profileupdate.htm"
							method="post">


							<div class="form-group">
								<label>First Name</label> <input class="form-control"
									name="firstName" value="Richa">
							</div>

							<div class="form-group">
								<label>Last Name</label> <input class="form-control"
									name="lastName" value="Bhatia">
							</div>

							<div class="form-group">
								<label>Email</label> <input type="email" class="form-control"
									name="emailId" value="rbh@gmail.com" readonly>
							</div>

							<div class="form-group">
								<label>User Name</label> <input class="form-control"
									name="userName" value="rbh" readonly>
							</div>
